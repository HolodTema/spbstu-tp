...
namespace holodilov
{
    ...
    std::ostream& operator<<(std::ostream& os, const manipulator::UllOctIO& ullOctIO);
    std::ostream& operator<<(std::ostream& os, const manipulator::CmpLspIO& cmpLspIO);
    std::ostream& operator<<(std::ostream& os, const manipulator::StringIO& stringIO);
